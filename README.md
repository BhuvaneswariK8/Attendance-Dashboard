...
```text
├── attendancefinal.py       # Core attendance recognition and logging script
├── class1.csv              # Class 1 attendance records
├── class2.csv              # Class 2 attendance records
├── class3.csv              # Class 3 attendance records
